...
import (
	...
	"github.com/containersolutions/redis-operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "db95d8a6.containersolutions.com",
	})
	if err != nil {
	...
	if err = (&controllers.RedisDatabaseReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("RedisDatabase"),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
